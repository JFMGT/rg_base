...
<form role="search" method="get" class="search-form" action="<?php echo esc_url(home_url('/')); ?>" style="display: flex; gap: 0.5rem; max-width: 600px;">
    <label style="flex: 1; position: relative;">
        <span class="screen-reader-text"><?php echo _x('Suche nach:', 'label', 'physio-therapy-pro'); ?></span>
        <input 
            type="search" 
            class="search-field" 
            placeholder="<?php echo esc_attr_x('Suchen...', 'placeholder', 'physio-therapy-pro'); ?>" 
    ...
    >
        🔍 <?php echo esc_attr_x('Suchen', 'submit button', 'physio-therapy-pro'); ?>
    </button>
</form>
